...
.method private decode(Lc8;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;
    .locals 12
    ...
    invoke-virtual {p1}, Lc8;->e()Lcom/google/zxing/qrcode/decoder/Version;

    move-result-object v0

    invoke-virtual {p1}, Lc8;->d()LLn;

    move-result-object v1

    invoke-virtual {v1}, LLn;->d()Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;

    move-result-object v1

    invoke-virtual {p1}, Lc8;->c()[B

    move-result-object p1

    invoke-static {p1, v0, v1}, Lcom/google/zxing/qrcode/decoder/a;->b([BLcom/google/zxing/qrcode/decoder/Version;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)[Lcom/google/zxing/qrcode/decoder/a;
    ...
    invoke-virtual {v6}, Lcom/google/zxing/qrcode/decoder/a;->c()I
    ...
    invoke-virtual {v7}, Lcom/google/zxing/qrcode/decoder/a;->a()[B

    move-result-object v8

    invoke-virtual {v7}, Lcom/google/zxing/qrcode/decoder/a;->c()I
    ...
    :cond_2
    invoke-static {v2, v0, v1, p2}, Lti;->a([BLcom/google/zxing/qrcode/decoder/Version;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;
...
.method public decode(Lcom/google/zxing/common/BitMatrix;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;
    ...
    invoke-direct {v0, p1}, Lc8;-><init>(Lcom/google/zxing/common/BitMatrix;)V

    const/4 p1, 0x0

    :try_start_0
    invoke-direct {p0, v0, p2}, Lcom/google/zxing/qrcode/decoder/Decoder;->decode(Lc8;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;
    ...
    :goto_0
    :try_start_1
    invoke-virtual {v0}, Lc8;->f()V

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lc8;->g(Z)V

    invoke-virtual {v0}, Lc8;->e()Lcom/google/zxing/qrcode/decoder/Version;

    invoke-virtual {v0}, Lc8;->d()LLn;
