...
.method private static addOrTally(Ljava/util/Collection;LfG;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static checkChecksum(LfG;LfG;)Z
    .locals 2
    ...
    invoke-virtual {p0}, LfG;->b()Lcom/google/zxing/oned/rss/FinderPattern;
    ...
    invoke-virtual {p1}, LfG;->b()Lcom/google/zxing/oned/rss/FinderPattern;
...
.method private static constructResult(LfG;LfG;)Lcom/google/zxing/Result;
    .locals 10
...
.method private decodePair(Lcom/google/zxing/common/BitArray;ZILjava/util/Map;)LfG;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p3, p4, p2, v2}, LfG;-><init>(IILcom/google/zxing/oned/rss/FinderPattern;)V
    :try_end_0
...
.method public decodeRow(ILcom/google/zxing/common/BitArray;Ljava/util/Map;)Lcom/google/zxing/Result;
    ...
    invoke-direct {p0, p2, v0, p1, p3}, Lcom/google/zxing/oned/rss/RSS14Reader;->decodePair(Lcom/google/zxing/common/BitArray;ZILjava/util/Map;)LfG;

    move-result-object v0

    iget-object v1, p0, Lcom/google/zxing/oned/rss/RSS14Reader;->possibleLeftPairs:Ljava/util/List;

    invoke-static {v1, v0}, Lcom/google/zxing/oned/rss/RSS14Reader;->addOrTally(Ljava/util/Collection;LfG;)V
    ...
    invoke-static {p3, p1}, Lcom/google/zxing/oned/rss/RSS14Reader;->addOrTally(Ljava/util/Collection;LfG;)V
    ...
    invoke-virtual {v1}, LfG;->a()I

    move-result v2

    if-le v2, v0, :cond_1

    invoke-static {p2, v1}, Lcom/google/zxing/oned/rss/RSS14Reader;->checkChecksum(LfG;LfG;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-static {p2, v1}, Lcom/google/zxing/oned/rss/RSS14Reader;->constructResult(LfG;LfG;)Lcom/google/zxing/Result;
