...
.method private findErrorLocations(LeC;)[I
    .locals 5
    ...
    invoke-virtual {p1, v3}, LeC;->b(I)I
...
.method private findErrorMagnitudes(LeC;LeC;[I)[I
    .locals 7

    invoke-virtual {p2}, LeC;->d()I
    ...
    invoke-virtual {p2, v2}, LeC;->c(I)I
    ...
    invoke-direct {p2, v0, v1}, LeC;-><init>(Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;[I)V
    ...
    invoke-virtual {p1, v4}, LeC;->b(I)I
    ...
    invoke-virtual {p2, v4}, LeC;->b(I)I
...
.method private runEuclideanAlgorithm(LeC;LeC;I)[LeC;
    .locals 11
    ...
    invoke-virtual {v2}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->getZero()LeC;
    ...
    invoke-virtual {v3}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->getOne()LeC;
    ...
    invoke-virtual {v4}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->getZero()LeC;
    ...
    invoke-virtual {p1, v5}, LeC;->c(I)I
    ...
    invoke-virtual {p2, v8}, LeC;->c(I)I
    ...
    invoke-virtual {v8, v6, v7}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->buildMonomial(II)LeC;

    move-result-object v8

    invoke-virtual {v4, v8}, LeC;->a(LeC;)LeC;

    move-result-object v4

    invoke-virtual {p1, v6, v7}, LeC;->h(II)LeC;

    move-result-object v6

    invoke-virtual {p2, v6}, LeC;->j(LeC;)LeC;
    ...
    :cond_1
    invoke-virtual {v4, v2}, LeC;->g(LeC;)LeC;

    move-result-object v4

    invoke-virtual {v4, v3}, LeC;->j(LeC;)LeC;

    move-result-object v3

    invoke-virtual {v3}, LeC;->i()LeC;
    ...
    :cond_3
    invoke-virtual {v2, v0}, LeC;->c(I)I
    ...
    invoke-virtual {v2, p2}, LeC;->f(I)LeC;

    move-result-object p3

    invoke-virtual {p1, p2}, LeC;->f(I)LeC;
...
.method public decode([II[I)I
    ...
    invoke-direct {v0, v1, p1}, LeC;-><init>(Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;[I)V
    ...
    invoke-virtual {v0, v6}, LeC;->b(I)I
    ...
    invoke-virtual {v0}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->getOne()LeC;
    ...
    invoke-direct {v7, v8, v6}, LeC;-><init>(Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;[I)V

    invoke-virtual {v0, v7}, LeC;->g(LeC;)LeC;
    ...
    invoke-direct {p3, v0, v1}, LeC;-><init>(Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;[I)V

    iget-object v0, p0, Lcom/google/zxing/pdf417/decoder/ec/ErrorCorrection;->field:Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;

    invoke-virtual {v0, p2, v5}, Lcom/google/zxing/pdf417/decoder/ec/ModulusGF;->buildMonomial(II)LeC;

    move-result-object v0

    invoke-direct {p0, v0, p3, p2}, Lcom/google/zxing/pdf417/decoder/ec/ErrorCorrection;->runEuclideanAlgorithm(LeC;LeC;I)[LeC;
    ...
    invoke-direct {p0, p3}, Lcom/google/zxing/pdf417/decoder/ec/ErrorCorrection;->findErrorLocations(LeC;)[I

    move-result-object v0

    invoke-direct {p0, p2, p3, v0}, Lcom/google/zxing/pdf417/decoder/ec/ErrorCorrection;->findErrorMagnitudes(LeC;LeC;[I)[I
