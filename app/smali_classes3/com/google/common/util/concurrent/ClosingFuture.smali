...
.method private constructor <init>(Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingCallable;Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lcom/google/common/util/concurrent/ClosingFuture;->closeables:Lcom/google/common/util/concurrent/ClosingFuture$m;

    invoke-static {p1}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v0, Lcom/google/common/util/concurrent/ClosingFuture$f;

    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/ClosingFuture$f;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingCallable;)V

    invoke-static {v0}, Lcom/google/common/util/concurrent/k;->a(Lcom/google/common/util/concurrent/AsyncCallable;)Lcom/google/common/util/concurrent/k;
...
.method private constructor <init>(Lcom/google/common/util/concurrent/ClosingFuture$ClosingCallable;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/ClosingFuture$e;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$ClosingCallable;)V

    invoke-static {v0}, Lcom/google/common/util/concurrent/k;->c(Ljava/util/concurrent/Callable;)Lcom/google/common/util/concurrent/k;
...
.method public synthetic constructor <init>(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/common/util/concurrent/ClosingFuture$d;)V
    .locals 0
...
.method public static synthetic access$1000(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$m;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/common/util/concurrent/ClosingFuture;->becomeSubsumedInto(Lcom/google/common/util/concurrent/ClosingFuture$m;)V

    return-void
.end method

.method public static synthetic access$1100(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/common/util/concurrent/ClosingFuture;->checkAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)V
...
.method public static synthetic access$200(Lcom/google/common/util/concurrent/ClosingFuture;)Lcom/google/common/util/concurrent/ClosingFuture$m;
    .locals 0

    iget-object p0, p0, Lcom/google/common/util/concurrent/ClosingFuture;->closeables:Lcom/google/common/util/concurrent/ClosingFuture$m;
...
.method private becomeSubsumedInto(Lcom/google/common/util/concurrent/ClosingFuture$m;)V
    .locals 2

    sget-object v0, Lcom/google/common/util/concurrent/ClosingFuture$n;->a:Lcom/google/common/util/concurrent/ClosingFuture$n;

    sget-object v1, Lcom/google/common/util/concurrent/ClosingFuture$n;->b:Lcom/google/common/util/concurrent/ClosingFuture$n;

    invoke-direct {p0, v0, v1}, Lcom/google/common/util/concurrent/ClosingFuture;->checkAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)V

    iget-object v0, p0, Lcom/google/common/util/concurrent/ClosingFuture;->closeables:Lcom/google/common/util/concurrent/ClosingFuture$m;

    invoke-static {}, Lcom/google/common/util/concurrent/MoreExecutors;->directExecutor()Ljava/util/concurrent/Executor;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/common/util/concurrent/ClosingFuture$m;->t(Ljava/io/Closeable;Ljava/util/concurrent/Executor;)V
...
.method private catchingAsyncMoreGeneric(Ljava/lang/Class;Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingFunction;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    invoke-direct {v0, p0, p2}, Lcom/google/common/util/concurrent/ClosingFuture$k;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingFunction;)V
...
.method private catchingMoreGeneric(Ljava/lang/Class;Lcom/google/common/util/concurrent/ClosingFuture$ClosingFunction;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    invoke-direct {v0, p0, p2}, Lcom/google/common/util/concurrent/ClosingFuture$j;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$ClosingFunction;)V
...
.method private checkAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lcom/google/common/util/concurrent/ClosingFuture;->compareAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)Z
...
.method private close()V
    ...
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/ClosingFuture$m;->close()V
...
.method private static closeQuietly(Ljava/io/Closeable;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v0, p0}, Lcom/google/common/util/concurrent/ClosingFuture$b;-><init>(Ljava/io/Closeable;)V
...
.method private compareAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)Z
    .locals 1
...
.method private derive(Lcom/google/common/util/concurrent/FluentFuture;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    iget-object p1, v0, Lcom/google/common/util/concurrent/ClosingFuture;->closeables:Lcom/google/common/util/concurrent/ClosingFuture$m;
...
.method public static eventuallyClosing(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    invoke-direct {v1, v0, p1}, Lcom/google/common/util/concurrent/ClosingFuture$d;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Ljava/util/concurrent/Executor;)V
...
.method public static whenAllComplete(Ljava/lang/Iterable;)Lcom/google/common/util/concurrent/ClosingFuture$Combiner;
    ...
    invoke-direct {v0, v1, p0, v2}, Lcom/google/common/util/concurrent/ClosingFuture$Combiner;-><init>(ZLjava/lang/Iterable;Lcom/google/common/util/concurrent/ClosingFuture$d;)V
...
.method public static whenAllSucceed(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;)Lcom/google/common/util/concurrent/ClosingFuture$Combiner2;
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/google/common/util/concurrent/ClosingFuture$Combiner2;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$d;)V
...
.method public static whenAllSucceed(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;)Lcom/google/common/util/concurrent/ClosingFuture$Combiner3;
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lcom/google/common/util/concurrent/ClosingFuture$Combiner3;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$d;)V
...
.method public static withoutCloser(Lcom/google/common/util/concurrent/AsyncFunction;)Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingFunction;
    ...
    invoke-direct {v0, p0}, Lcom/google/common/util/concurrent/ClosingFuture$i;-><init>(Lcom/google/common/util/concurrent/AsyncFunction;)V
...
.method public finishToFuture()Lcom/google/common/util/concurrent/FluentFuture;
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/common/util/concurrent/ClosingFuture;->compareAndUpdateState(Lcom/google/common/util/concurrent/ClosingFuture$n;Lcom/google/common/util/concurrent/ClosingFuture$n;)Z
    ...
    new-instance v1, Lcom/google/common/util/concurrent/ClosingFuture$l;

    invoke-direct {v1, p0}, Lcom/google/common/util/concurrent/ClosingFuture$l;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;)V
    ...
    :cond_0
    sget-object v0, Lcom/google/common/util/concurrent/ClosingFuture$c;->a:[I
    ...
    check-cast v1, Lcom/google/common/util/concurrent/ClosingFuture$n;
...
.method public finishToValueAndCloser(Lcom/google/common/util/concurrent/ClosingFuture$ValueAndCloserConsumer;Ljava/util/concurrent/Executor;)V
    ...
    sget-object p1, Lcom/google/common/util/concurrent/ClosingFuture$c;->a:[I
    ...
    check-cast p2, Lcom/google/common/util/concurrent/ClosingFuture$n;
...
.method public transform(Lcom/google/common/util/concurrent/ClosingFuture$ClosingFunction;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/ClosingFuture$g;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$ClosingFunction;)V
...
.method public transformAsync(Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingFunction;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ClosingFuture;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/ClosingFuture$h;-><init>(Lcom/google/common/util/concurrent/ClosingFuture;Lcom/google/common/util/concurrent/ClosingFuture$AsyncClosingFunction;)V
...
.method public whenClosedCountDown()Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/ClosingFuture$m;->x()Ljava/util/concurrent/CountDownLatch;
