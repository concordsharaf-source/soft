...
.method public asMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/collect/d;->asMap:Ljava/util/Map;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/d;->createAsMap()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/d;->asMap:Ljava/util/Map;
...
.method public entries()Ljava/util/Collection;
    ...
    iget-object v0, p0, Lcom/google/common/collect/d;->entries:Ljava/util/Collection;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/d;->createEntries()Ljava/util/Collection;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/d;->entries:Ljava/util/Collection;
...
.method public keySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/common/collect/d;->keySet:Ljava/util/Set;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/d;->createKeySet()Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/d;->keySet:Ljava/util/Set;
...
.method public keys()Lcom/google/common/collect/Multiset;
    ...
    iget-object v0, p0, Lcom/google/common/collect/d;->keys:Lcom/google/common/collect/Multiset;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/d;->createKeys()Lcom/google/common/collect/Multiset;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/d;->keys:Lcom/google/common/collect/Multiset;
...
.method public putAll(Lcom/google/common/collect/Multimap;)Z
    ...
    invoke-virtual {p0, v2, v1}, Lcom/google/common/collect/d;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public replaceValues(Ljava/lang/Object;Ljava/lang/Iterable;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/common/collect/d;->putAll(Ljava/lang/Object;Ljava/lang/Iterable;)Z
...
.method public values()Ljava/util/Collection;
    ...
    iget-object v0, p0, Lcom/google/common/collect/d;->values:Ljava/util/Collection;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/d;->createValues()Ljava/util/Collection;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/d;->values:Ljava/util/Collection;
