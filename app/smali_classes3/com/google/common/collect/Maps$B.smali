...
.method public constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/google/common/collect/Maps$B;->a:Ljava/util/Map;

    invoke-static {p2}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$B;->b:Ljava/util/Map;

    invoke-static {p3}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$B;->c:Ljava/util/Map;

    invoke-static {p4}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$B;->d:Ljava/util/Map;
...
.method public areEqual()Z
    ...
    iget-object v0, p0, Lcom/google/common/collect/Maps$B;->b:Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/collect/Maps$B;->d:Ljava/util/Map;
...
.method public entriesInCommon()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/collect/Maps$B;->c:Ljava/util/Map;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/Maps$B;->entriesOnlyOnLeft()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/Maps$B;->entriesOnlyOnRight()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/Maps$B;->entriesInCommon()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/Maps$B;->entriesDiffering()Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/Maps$B;->areEqual()Z
    ...
    iget-object v1, p0, Lcom/google/common/collect/Maps$B;->a:Ljava/util/Map;
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/common/collect/Maps$B;->b:Ljava/util/Map;
    ...
    :cond_2
    iget-object v1, p0, Lcom/google/common/collect/Maps$B;->d:Ljava/util/Map;
