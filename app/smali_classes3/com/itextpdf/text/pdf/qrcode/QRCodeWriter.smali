...
.method private static renderResult(Lcom/itextpdf/text/pdf/qrcode/QRCode;II)Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;
    ...
    new-instance v10, Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;

    invoke-direct {v10, v5, v6}, Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;-><init>(II)V

    invoke-virtual {v10}, Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;->getArray()[[B
    ...
    invoke-static {v13, v15}, Lcom/itextpdf/text/pdf/qrcode/QRCodeWriter;->setRowColor([BB)V
    ...
    invoke-static {v0, v1}, Lcom/itextpdf/text/pdf/qrcode/QRCodeWriter;->setRowColor([BB)V
...
.method public encode(Ljava/lang/String;IILjava/util/Map;)Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;
    ...
    sget-object v0, Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;->L:Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;

    if-eqz p4, :cond_0

    sget-object v1, Lcom/itextpdf/text/pdf/qrcode/EncodeHintType;->ERROR_CORRECTION:Lcom/itextpdf/text/pdf/qrcode/EncodeHintType;

    invoke-interface {p4, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;
    ...
    :cond_0
    new-instance v1, Lcom/itextpdf/text/pdf/qrcode/QRCode;

    invoke-direct {v1}, Lcom/itextpdf/text/pdf/qrcode/QRCode;-><init>()V

    invoke-static {p1, v0, p4, v1}, Lcom/itextpdf/text/pdf/qrcode/Encoder;->encode(Ljava/lang/String;Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;Ljava/util/Map;Lcom/itextpdf/text/pdf/qrcode/QRCode;)V

    invoke-static {v1, p2, p3}, Lcom/itextpdf/text/pdf/qrcode/QRCodeWriter;->renderResult(Lcom/itextpdf/text/pdf/qrcode/QRCode;II)Lcom/itextpdf/text/pdf/qrcode/ByteMatrix;
