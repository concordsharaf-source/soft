...
.method private addPadding(I)V
    ...
    :cond_2
    invoke-direct {p0, v0, v1}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeChars(IC)V
...
.method private canBeRDFAttrProp(Lcom/itextpdf/xmp/impl/XMPNode;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/itextpdf/xmp/options/Options;->containsOneOf(I)Z
...
.method private serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->getName()Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-direct {v0, v3}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeIndent(I)V

    const/16 v5, 0x3c

    invoke-direct {v0, v5}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(I)V

    invoke-direct {v0, v4}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V

    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->iterateQualifier()Ljava/util/Iterator;
    ...
    check-cast v9, Lcom/itextpdf/xmp/impl/XMPNode;

    sget-object v14, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->RDF_ATTR_QUALIFIER:Ljava/util/Set;

    invoke-virtual {v9}, Lcom/itextpdf/xmp/impl/XMPNode;->getName()Ljava/lang/String;
    ...
    invoke-direct {v0, v12}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(I)V

    invoke-virtual {v9}, Lcom/itextpdf/xmp/impl/XMPNode;->getName()Ljava/lang/String;

    move-result-object v12

    invoke-direct {v0, v12}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V

    invoke-direct {v0, v11}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V

    invoke-virtual {v9}, Lcom/itextpdf/xmp/impl/XMPNode;->getValue()Ljava/lang/String;

    move-result-object v9

    invoke-direct {v0, v9, v13}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V

    invoke-direct {v0, v10}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(I)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeNewline()V

    add-int/lit8 v3, v3, 0x1

    invoke-direct {v0, v3}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeIndent(I)V

    invoke-direct {v0, v14}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    :cond_5
    invoke-direct {v0, v9}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v13, v7}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V
    ...
    invoke-virtual {v8}, Lcom/itextpdf/xmp/impl/XMPNode;->getName()Ljava/lang/String;
    ...
    invoke-direct {v0, v8, v2, v6, v7}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V
    ...
    invoke-direct {v0, v5}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    :cond_a
    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->getOptions()Lcom/itextpdf/xmp/options/PropertyOptions;

    move-result-object v7

    invoke-virtual {v7}, Lcom/itextpdf/xmp/options/PropertyOptions;->isCompositeProperty()Z
    ...
    invoke-direct {v0, v2}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V

    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->getValue()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1, v13}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V

    const-string v1, "\"/>"

    invoke-direct {v0, v1}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v6}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V
    ...
    :cond_d
    :goto_6
    invoke-direct {v0, v15}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Lcom/itextpdf/xmp/options/PropertyOptions;->isArray()Z
    ...
    invoke-direct {v0, v1, v13, v5}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->emitRDFArrayTag(Lcom/itextpdf/xmp/impl/XMPNode;ZI)V

    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->getOptions()Lcom/itextpdf/xmp/options/PropertyOptions;

    move-result-object v7

    invoke-virtual {v7}, Lcom/itextpdf/xmp/options/PropertyOptions;->isArrayAltText()Z

    move-result v7

    if-eqz v7, :cond_f

    invoke-static/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNodeUtils;->normalizeLangArray(Lcom/itextpdf/xmp/impl/XMPNode;)V

    :cond_f
    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->iterateChildren()Ljava/util/Iterator;
    ...
    invoke-direct {v0, v8, v2, v6, v9}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V

    goto :goto_7

    :cond_10
    invoke-direct {v0, v1, v6, v5}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->emitRDFArrayTag(Lcom/itextpdf/xmp/impl/XMPNode;ZI)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/itextpdf/xmp/impl/XMPNode;->hasChildren()Z
    ...
    invoke-direct {v0, v1}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeIndent(I)V
    ...
    check-cast v7, Lcom/itextpdf/xmp/impl/XMPNode;

    add-int/lit8 v8, v3, 0x1

    invoke-direct {v0, v7, v2, v6, v8}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V
    ...
    invoke-direct {v0, v2}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->canBeRDFAttrProp(Lcom/itextpdf/xmp/impl/XMPNode;)Z
    ...
    invoke-direct {v0, v5}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->writeIndent(I)V
    ...
    invoke-direct {v0, v7}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, v13}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V

    const/16 v2, 0x22

    invoke-direct {v0, v2}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(I)V
...
.method private serializeCanonicalRDFSchema(Lcom/itextpdf/xmp/impl/XMPNode;I)V
    ...
    invoke-direct {p0, v0, v1, v3, v2}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->serializeCanonicalRDFProperty(Lcom/itextpdf/xmp/impl/XMPNode;ZZI)V
...
.method private serializeCompactRDFSimpleProp(Lcom/itextpdf/xmp/impl/XMPNode;)[Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lcom/itextpdf/xmp/options/PropertyOptions;->isURI()Z
    ...
    invoke-direct {p0, p1, v1}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v3}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->write(I)V

    invoke-virtual {p1}, Lcom/itextpdf/xmp/impl/XMPNode;->getValue()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1, v0}, Lcom/itextpdf/xmp/impl/XMPSerializerRDF;->appendNodeValue(Ljava/lang/String;Z)V
