...
.method public static a(Ljava/util/List;)V
    ...
    invoke-static {p0}, Lgh;->c(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    invoke-static {v0}, Lgh;->b(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {v3}, Lgh$b;->d()Ljava/util/Set;
    ...
    invoke-virtual {v5, v3}, Lgh$b;->g(Lgh$b;)V

    invoke-virtual {v5}, Lgh$b;->f()Z
    ...
    invoke-virtual {v1}, Lgh$b;->f()Z

    move-result v2

    if-nez v2, :cond_4

    invoke-virtual {v1}, Lgh$b;->e()Z

    move-result v2

    if-nez v2, :cond_4

    invoke-virtual {v1}, Lgh$b;->c()Lcom/google/firebase/components/Component;
...
.method public static c(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-direct {v4, v2}, Lgh$b;-><init>(Lcom/google/firebase/components/Component;)V
    ...
    invoke-direct {v7, v6, v8, v3}, Lgh$c;-><init>(Ljava/lang/Class;ZLgh$a;)V
    ...
    invoke-static {v7}, Lgh$c;->a(Lgh$c;)Z
    ...
    invoke-virtual {v2}, Lgh$b;->c()Lcom/google/firebase/components/Component;
    ...
    invoke-direct {v6, v7, v5, v3}, Lgh$c;-><init>(Ljava/lang/Class;ZLgh$a;)V
    ...
    invoke-virtual {v2, v6}, Lgh$b;->a(Lgh$b;)V

    invoke-virtual {v6, v2}, Lgh$b;->b(Lgh$b;)V
