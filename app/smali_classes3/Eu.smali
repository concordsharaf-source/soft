...
.method public constructor <init>(LEu;)V
    ...
    iput-object v0, p0, LEu;->a:LEu;

    const/4 v0, 0x1

    iput-boolean v0, p0, LEu;->b:Z

    iget-object v0, p1, LEu;->c:Landroid/util/JsonWriter;

    iput-object v0, p0, LEu;->c:Landroid/util/JsonWriter;

    iget-object v0, p1, LEu;->d:Ljava/util/Map;

    iput-object v0, p0, LEu;->d:Ljava/util/Map;

    iget-object v0, p1, LEu;->e:Ljava/util/Map;

    iput-object v0, p0, LEu;->e:Ljava/util/Map;

    iget-object v0, p1, LEu;->f:Lcom/google/firebase/encoders/ObjectEncoder;

    iput-object v0, p0, LEu;->f:Lcom/google/firebase/encoders/ObjectEncoder;

    iget-boolean p1, p1, LEu;->g:Z

    iput-boolean p1, p0, LEu;->g:Z
...
.method public constructor <init>(Ljava/io/Writer;Ljava/util/Map;Ljava/util/Map;Lcom/google/firebase/encoders/ObjectEncoder;Z)V
    ...
    iput-object p2, p0, LEu;->d:Ljava/util/Map;

    iput-object p3, p0, LEu;->e:Ljava/util/Map;

    iput-object p4, p0, LEu;->f:Lcom/google/firebase/encoders/ObjectEncoder;

    iput-boolean p5, p0, LEu;->g:Z
...
# virtual methods
.method public a(D)LEu;
    .locals 1

    invoke-virtual {p0}, LEu;->s()V

    iget-object v0, p0, LEu;->c:Landroid/util/JsonWriter;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;D)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, p2, p3}, LEu;->g(Ljava/lang/String;D)LEu;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;F)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, v0, v1}, LEu;->g(Ljava/lang/String;D)LEu;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;I)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, p2}, LEu;->h(Ljava/lang/String;I)LEu;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;J)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, p2, p3}, LEu;->i(Ljava/lang/String;J)LEu;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;Ljava/lang/Object;)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, p2}, LEu;->j(Ljava/lang/String;Ljava/lang/Object;)LEu;
...
.method public add(Lcom/google/firebase/encoders/FieldDescriptor;Z)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, p2}, LEu;->k(Ljava/lang/String;Z)LEu;
...
.method public bridge synthetic add(D)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1, p2}, LEu;->a(D)LEu;
...
.method public bridge synthetic add(F)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->b(F)LEu;
...
.method public bridge synthetic add(I)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->c(I)LEu;
...
.method public bridge synthetic add(J)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1, p2}, LEu;->d(J)LEu;
...
.method public bridge synthetic add(Ljava/lang/String;)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->f(Ljava/lang/String;)LEu;
...
.method public bridge synthetic add(Z)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->l(Z)LEu;
...
.method public bridge synthetic add([B)Lcom/google/firebase/encoders/ValueEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->m([B)LEu;
...
.method public e(Ljava/lang/Object;Z)LEu;
    .locals 6
    ...
    invoke-virtual {p0, p1}, LEu;->n(Ljava/lang/Object;)Z
    ...
    iget-object p1, p0, LEu;->c:Landroid/util/JsonWriter;
    ...
    iget-object p2, p0, LEu;->c:Landroid/util/JsonWriter;
    ...
    iget-object v3, p0, LEu;->c:Landroid/util/JsonWriter;
    ...
    invoke-virtual {p0, v2, v3}, LEu;->d(J)LEu;
    ...
    iget-object v4, p0, LEu;->c:Landroid/util/JsonWriter;
    ...
    invoke-virtual {p0, v3, v0}, LEu;->e(Ljava/lang/Object;Z)LEu;
    ...
    invoke-virtual {p0, p2, v0}, LEu;->e(Ljava/lang/Object;Z)LEu;
    ...
    invoke-virtual {p0, v3, p2}, LEu;->j(Ljava/lang/String;Ljava/lang/Object;)LEu;
    :try_end_0
    ...
    invoke-virtual {p0, v0, p1, p2}, LEu;->p(Lcom/google/firebase/encoders/ObjectEncoder;Ljava/lang/Object;Z)LEu;
    ...
    :cond_10
    iget-object v0, p0, LEu;->e:Ljava/util/Map;
    ...
    :cond_12
    iget-object v0, p0, LEu;->f:Lcom/google/firebase/encoders/ObjectEncoder;
...
.method public f(Ljava/lang/String;)LEu;
    .locals 1
...
.method public g(Ljava/lang/String;D)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p2, p3}, LEu;->a(D)LEu;
...
.method public h(Ljava/lang/String;I)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p2}, LEu;->c(I)LEu;
...
.method public i(Ljava/lang/String;J)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p2, p3}, LEu;->d(J)LEu;
...
.method public inline(Ljava/lang/Object;)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1, v0}, LEu;->e(Ljava/lang/Object;Z)LEu;
...
.method public j(Ljava/lang/String;Ljava/lang/Object;)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, LEu;->r(Ljava/lang/String;Ljava/lang/Object;)LEu;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, LEu;->q(Ljava/lang/String;Ljava/lang/Object;)LEu;
...
.method public k(Ljava/lang/String;Z)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p2}, LEu;->l(Z)LEu;
...
.method public nested(Lcom/google/firebase/encoders/FieldDescriptor;)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-virtual {p0, p1}, LEu;->nested(Ljava/lang/String;)Lcom/google/firebase/encoders/ObjectEncoderContext;
...
.method public nested(Ljava/lang/String;)Lcom/google/firebase/encoders/ObjectEncoderContext;
    ...
    invoke-direct {v0, p0}, LEu;-><init>(LEu;)V
...
.method public p(Lcom/google/firebase/encoders/ObjectEncoder;Ljava/lang/Object;Z)LEu;
    .locals 1
...
.method public final q(Ljava/lang/String;Ljava/lang/Object;)LEu;
    .locals 1
    ...
    invoke-virtual {p0, p2, p1}, LEu;->e(Ljava/lang/Object;Z)LEu;
...
.method public final r(Ljava/lang/String;Ljava/lang/Object;)LEu;
    .locals 1
