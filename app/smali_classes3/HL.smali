...
.field public final f:Lcom/google/firebase/components/ComponentContainer;
...
.method public constructor <init>(Lcom/google/firebase/components/Component;Lcom/google/firebase/components/ComponentContainer;)V
    ...
    iput-object v0, p0, LHL;->a:Ljava/util/Set;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableSet(Ljava/util/Set;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, LHL;->b:Ljava/util/Set;

    invoke-static {v2}, Ljava/util/Collections;->unmodifiableSet(Ljava/util/Set;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, LHL;->c:Ljava/util/Set;

    invoke-static {v3}, Ljava/util/Collections;->unmodifiableSet(Ljava/util/Set;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, LHL;->d:Ljava/util/Set;

    invoke-virtual {p1}, Lcom/google/firebase/components/Component;->getPublishedEvents()Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, LHL;->e:Ljava/util/Set;

    iput-object p2, p0, LHL;->f:Lcom/google/firebase/components/ComponentContainer;
...
.method public get(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LHL;->a:Ljava/util/Set;
    ...
    iget-object v0, p0, LHL;->f:Lcom/google/firebase/components/ComponentContainer;
    ...
    iget-object v1, p0, LHL;->e:Ljava/util/Set;

    check-cast v0, Lcom/google/firebase/events/Publisher;

    invoke-direct {p1, v1, v0}, LHL$a;-><init>(Ljava/util/Set;Lcom/google/firebase/events/Publisher;)V
...
.method public getProvider(Ljava/lang/Class;)Lcom/google/firebase/inject/Provider;
    ...
    iget-object v0, p0, LHL;->b:Ljava/util/Set;
...
.method public setOf(Ljava/lang/Class;)Ljava/util/Set;
    ...
    iget-object v0, p0, LHL;->c:Ljava/util/Set;
...
.method public setOfProvider(Ljava/lang/Class;)Lcom/google/firebase/inject/Provider;
    ...
    iget-object v0, p0, LHL;->d:Ljava/util/Set;
