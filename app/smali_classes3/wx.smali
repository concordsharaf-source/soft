...
.method public static h(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lux;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs i([LdG;)Ljava/util/HashMap;
    .locals 2
...
.method public static varargs j([LdG;)Ljava/util/Map;
    .locals 2
    ...
    invoke-static {p0, v0}, Lwx;->u([LdG;Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs k([LdG;)Ljava/util/Map;
    .locals 2
...
.method public static final l(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lvx;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static m(Ljava/util/Map;LdG;)Ljava/util/Map;
    .locals 1
...
.method public static n(Ljava/util/Map;LyO;)V
    .locals 2
...
.method public static p(Ljava/util/Map;[LdG;)V
    .locals 4
...
.method public static q(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lwx;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Lvx;->e(LdG;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lwx;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lwx;->l(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lwx;->o(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static s(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lwx;->v(Ljava/util/Map;)Ljava/util/Map;
...
.method public static t([LdG;)Ljava/util/Map;
    .locals 2
...
.method public static final u([LdG;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {p1, p0}, Lwx;->p(Ljava/util/Map;[LdG;)V
