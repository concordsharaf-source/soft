...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-static {p2}, LzP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mId:Ljava/lang/String;

    invoke-static {p2}, LAP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mPackageName:Ljava/lang/String;

    invoke-static {p2}, LCP;->a(Landroid/content/pm/ShortcutInfo;)[Landroid/content/Intent;
    ...
    invoke-static {p2}, LDP;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/ComponentName;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mActivity:Landroid/content/ComponentName;

    invoke-static {p2}, LEP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLabel:Ljava/lang/CharSequence;

    invoke-static {p2}, LFP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLongLabel:Ljava/lang/CharSequence;

    invoke-static {p2}, LGP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, LHP;->a(Landroid/content/pm/ShortcutInfo;)I
    ...
    :cond_0
    invoke-static {p2}, LQP;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    :goto_1
    invoke-static {p2}, LIP;->a(Landroid/content/pm/ShortcutInfo;)Ljava/util/Set;

    move-result-object v1

    iput-object v1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mCategories:Ljava/util/Set;

    invoke-static {p2}, LlP;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
    ...
    invoke-static {p2}, LJP;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/UserHandle;

    move-result-object v1

    iput-object v1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mUser:Landroid/os/UserHandle;

    invoke-static {p2}, LKP;->a(Landroid/content/pm/ShortcutInfo;)J
    ...
    invoke-static {p2}, LLP;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-static {p2}, LRP;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-static {p2}, LBP;->a(Landroid/content/pm/ShortcutInfo;)I
