...
.method private buildLegacyExtrasBundle()Landroid/os/PersistableBundle;
    ...
    invoke-static {v0, v1, v2}, LnP;->a(Landroid/os/PersistableBundle;Ljava/lang/String;Z)V
...
.method public static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, LjP;->a(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    invoke-static {p0}, LkP;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    :cond_1
    invoke-static {p0}, LlP;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method public static getLongLivedFromExtra(Landroid/os/PersistableBundle;)Z
    ...
    :cond_0
    invoke-static {p0, v0}, LmP;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)Z
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-static {}, LpP;->a()V

    iget-object v0, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mContext:Landroid/content/Context;

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mId:Ljava/lang/String;

    invoke-static {v0, v1}, LoP;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLabel:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, LfP;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIntents:[Landroid/content/Intent;

    invoke-static {v0, v1}, LuP;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LvP;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LwP;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LxP;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LyP;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LgP;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_4
    iget v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I

    invoke-static {v0, v1}, LhP;->a(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mExtras:Landroid/os/PersistableBundle;

    if-eqz v1, :cond_5

    invoke-static {v0, v1}, LsP;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_6
    invoke-static {v0, v2}, LiP;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, LqP;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_8
    iget-boolean v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z

    invoke-static {v0, v1}, LrP;->a(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_a
    invoke-static {v0}, LtP;->a(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
