...
.field private final getMatrix:LFp;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LFp;"
        }
...
.method public constructor <init>(LFp;)V
    ...
    iput-object p1, p0, Landroidx/compose/ui/platform/LayerMatrixCache;->getMatrix:LFp;
...
.method public final calculateMatrix-GrdbGEg(Ljava/lang/Object;)[F
    ...
    :cond_2
    iget-object v2, p0, Landroidx/compose/ui/platform/LayerMatrixCache;->getMatrix:LFp;

    invoke-interface {v2, p1, v1}, LFp;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
