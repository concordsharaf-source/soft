...
# direct methods
.method public static final synthetic viewModels(Landroidx/activity/ComponentActivity;Lop;)Lmv;
    .locals 4
    ...
    invoke-direct {v0, v1, v2, p1, v3}, Landroidx/lifecycle/ViewModelLazy;-><init>(LJu;Lop;Lop;Lop;)V

    return-object v0
.end method

.method public static final synthetic viewModels(Landroidx/activity/ComponentActivity;Lop;Lop;)Lmv;
    .locals 4
    .annotation build Landroidx/annotation/MainThread;
    .end annotation
    ...
    invoke-direct {v3, p1, p0}, Landroidx/activity/ActivityViewModelLazyKt$viewModels$4;-><init>(Lop;Landroidx/activity/ComponentActivity;)V

    invoke-direct {v0, v1, v2, p2, v3}, Landroidx/lifecycle/ViewModelLazy;-><init>(LJu;Lop;Lop;Lop;)V

    return-object v0
.end method

.method public static synthetic viewModels$default(Landroidx/activity/ComponentActivity;Lop;ILjava/lang/Object;)Lmv;
    .locals 2
    ...
    invoke-static {p3, v0}, Lzt;->m(ILjava/lang/String;)V
    ...
    invoke-direct {p2, p3, v0, p1, v1}, Landroidx/lifecycle/ViewModelLazy;-><init>(LJu;Lop;Lop;Lop;)V

    return-object p2
.end method

.method public static synthetic viewModels$default(Landroidx/activity/ComponentActivity;Lop;Lop;ILjava/lang/Object;)Lmv;
    .locals 2
    ...
    invoke-static {p4, v0}, Lzt;->m(ILjava/lang/String;)V

    const-class p4, Landroidx/lifecycle/ViewModel;

    invoke-static {p4}, LQJ;->b(Ljava/lang/Class;)LJu;
    ...
    invoke-direct {v1, p1, p0}, Landroidx/activity/ActivityViewModelLazyKt$viewModels$4;-><init>(Lop;Landroidx/activity/ComponentActivity;)V

    invoke-direct {p3, p4, v0, p2, v1}, Landroidx/lifecycle/ViewModelLazy;-><init>(LJu;Lop;Lop;Lop;)V
