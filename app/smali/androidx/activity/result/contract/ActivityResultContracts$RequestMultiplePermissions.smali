...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/activity/result/contract/ActivityResultContracts$RequestMultiplePermissions$Companion;-><init>(LDi;)V
...
.method public parseResult(ILandroid/content/Intent;)Ljava/util/Map;
    ...
    :cond_4
    invoke-static {p1}, LR5;->H([Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    check-cast p1, Ljava/lang/Iterable;

    invoke-static {p1, v0}, Lkc;->K0(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p1

    check-cast p1, Ljava/lang/Iterable;

    invoke-static {p1}, Lwx;->q(Ljava/lang/Iterable;)Ljava/util/Map;
