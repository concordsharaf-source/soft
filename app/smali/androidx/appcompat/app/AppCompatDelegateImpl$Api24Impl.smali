...
.method public static generateConfigDelta_locale(Landroid/content/res/Configuration;Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Lt4;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;

    move-result-object p0

    invoke-static {p1}, Lt4;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;

    move-result-object v0

    invoke-static {p0, v0}, Lu4;->a(Landroid/os/LocaleList;Ljava/lang/Object;)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {p2, v0}, Lv4;->a(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
...
.method public static getLocales(Landroid/content/res/Configuration;)Landroidx/core/os/LocaleListCompat;
    ...
    invoke-static {p0}, Ly4;->a(Landroid/os/LocaleList;)Ljava/lang/String;
...
.method public static setDefaultLocales(Landroidx/core/os/LocaleListCompat;)V
    ...
    invoke-static {p0}, Lw4;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object p0

    invoke-static {p0}, Lx4;->a(Landroid/os/LocaleList;)V
...
.method public static setLocales(Landroid/content/res/Configuration;Landroidx/core/os/LocaleListCompat;)V
    ...
    invoke-static {p1}, Lw4;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object p1

    invoke-static {p0, p1}, Lv4;->a(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
