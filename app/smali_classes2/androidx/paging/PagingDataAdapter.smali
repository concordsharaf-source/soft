...
.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/paging/PagingDataAdapter;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;LVf;ILDi;)V

    return-void
.end method

.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;LVf;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, v1, p2, p3}, Landroidx/paging/AsyncPagingDataDiffer;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;Landroidx/recyclerview/widget/ListUpdateCallback;LVf;LVf;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/paging/PagingDataAdapter;->addLoadStateListener(Lqp;)V

    invoke-virtual {v0}, Landroidx/paging/AsyncPagingDataDiffer;->getLoadStateFlow()LTm;

    move-result-object p1

    iput-object p1, p0, Landroidx/paging/PagingDataAdapter;->loadStateFlow:LTm;

    invoke-virtual {v0}, Landroidx/paging/AsyncPagingDataDiffer;->getOnPagesUpdatedFlow()LTm;

    move-result-object p1

    iput-object p1, p0, Landroidx/paging/PagingDataAdapter;->onPagesUpdatedFlow:LTm;

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;LVf;ILDi;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Landroidx/paging/PagingDataAdapter;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;LVf;)V

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/paging/PagingDataAdapter;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LVf;LVf;)V

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;ILDi;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Landroidx/paging/PagingDataAdapter;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;)V

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;LXf;)V
    .locals 1
...
.method public synthetic constructor <init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;LXf;ILDi;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Landroidx/paging/PagingDataAdapter;-><init>(Landroidx/recyclerview/widget/DiffUtil$ItemCallback;LXf;LXf;)V
...
.method public final addLoadStateListener(Lqp;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/paging/AsyncPagingDataDiffer;->addLoadStateListener(Lqp;)V
...
.method public final addOnPagesUpdatedListener(Lop;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/paging/AsyncPagingDataDiffer;->addOnPagesUpdatedListener(Lop;)V
...
.method public final getLoadStateFlow()LTm;
    ...
    iget-object v0, p0, Landroidx/paging/PagingDataAdapter;->loadStateFlow:LTm;
...
.method public final getOnPagesUpdatedFlow()LTm;
    ...
    iget-object v0, p0, Landroidx/paging/PagingDataAdapter;->onPagesUpdatedFlow:LTm;
...
.method public final removeLoadStateListener(Lqp;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/paging/AsyncPagingDataDiffer;->removeLoadStateListener(Lqp;)V
...
.method public final removeOnPagesUpdatedListener(Lop;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/paging/AsyncPagingDataDiffer;->removeOnPagesUpdatedListener(Lop;)V
...
.method public final submitData(Landroidx/paging/PagingData;LOf;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/paging/AsyncPagingDataDiffer;->submitData(Landroidx/paging/PagingData;LOf;)Ljava/lang/Object;
...
.method public final withLoadStateFooter(Landroidx/paging/LoadStateAdapter;)Landroidx/recyclerview/widget/ConcatAdapter;
    ...
    invoke-virtual {p0, v0}, Landroidx/paging/PagingDataAdapter;->addLoadStateListener(Lqp;)V
