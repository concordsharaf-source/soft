...
# direct methods
.method public constructor <init>(LVf;JLFp;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, LTS;->a(Lbu;)Lae;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;LFp;JLdg;Lop;)V
...
.method public synthetic constructor <init>(LVf;JLFp;ILDi;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(LVf;JLFp;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_ktx_release(LOf;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;LOf;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(LOf;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_ktx_release(Landroidx/lifecycle/LiveData;LOf;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;LOf;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_ktx_release(LOf;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;LOf;)Ljava/lang/Object;
