...
.method private static convertContentUriTrigger(Landroidx/work/Constraints$ContentUriTrigger;)Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    invoke-static {}, LnT;->a()V

    invoke-virtual {p0}, Landroidx/work/Constraints$ContentUriTrigger;->getUri()Landroid/net/Uri;

    move-result-object p0

    invoke-static {p0, v0}, LmT;->a(Landroid/net/Uri;I)Landroid/app/job/JobInfo$TriggerContentUri;
...
.method public static setRequiredNetwork(Landroid/app/job/JobInfo$Builder;Landroidx/work/NetworkType;)V
    ...
    invoke-static {p0, p1}, LeT;->a(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)Landroid/app/job/JobInfo$Builder;
...
.method public convert(Landroidx/work/impl/model/WorkSpec;I)Landroid/app/job/JobInfo;
    ...
    invoke-static {v1, v2, v3}, LnP;->a(Landroid/os/PersistableBundle;Ljava/lang/String;Z)V
    ...
    invoke-static {p2, v3}, LfT;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v8}, LgT;->a(Landroid/app/job/JobInfo$Builder;Landroid/app/job/JobInfo$TriggerContentUri;)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v8, v9}, LhT;->a(Landroid/app/job/JobInfo$Builder;J)Landroid/app/job/JobInfo$Builder;

    invoke-virtual {v0}, Landroidx/work/Constraints;->getContentTriggerMaxDelayMillis()J

    move-result-wide v8

    invoke-static {p2, v8, v9}, LiT;->a(Landroid/app/job/JobInfo$Builder;J)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v8}, LjT;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;

    invoke-virtual {v0}, Landroidx/work/Constraints;->requiresStorageNotLow()Z

    move-result v0

    invoke-static {p2, v0}, LkT;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v3}, LlT;->a(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
