...
.method public setDefaultNotificationChannelId(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, LEq;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
...
.method public showErrorDialogFragment(Landroid/app/Activity;ILandroidx/activity/result/ActivityResultLauncher;Landroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-direct {v5, p0, p1, p2, p3}, LX10;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/app/Activity;ILandroidx/activity/result/ActivityResultLauncher;)V
...
.method public final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {v5, v1}, LEq;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {v1, p1, p4}, LIq;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p1

    invoke-static {v5, p1}, LFq;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    goto :goto_1

    :cond_6
    invoke-static {p4}, LGq;->a(Landroid/app/NotificationChannel;)Ljava/lang/CharSequence;
    ...
    invoke-static {p4, p1}, LHq;->a(Landroid/app/NotificationChannel;Ljava/lang/CharSequence;)V

    invoke-static {v5, p4}, LFq;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
...
.method public final zaf(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lm20;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/content/Context;)V
