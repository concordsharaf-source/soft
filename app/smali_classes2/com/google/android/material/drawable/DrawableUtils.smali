...
.method public static compositeTwoLayeredDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3, v1, p2, p3}, Lmk;->a(Landroid/graphics/drawable/LayerDrawable;III)V

    const/16 p0, 0x11

    invoke-static {v3, v1, p0}, Lok;->a(Landroid/graphics/drawable/LayerDrawable;II)V
...
.method public static getColorStateListOrNull(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, Lqk;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lsk;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, Luk;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static setRippleDrawableRadius(Landroid/graphics/drawable/RippleDrawable;I)V
    ...
    invoke-static {p0, p1}, LJW;->a(Landroid/graphics/drawable/RippleDrawable;I)V
