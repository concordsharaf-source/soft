...
.method public build()Landroid/text/StaticLayout;
    ...
    invoke-static {v4, v2, v5, v6, v3}, LIR;->a(Ljava/lang/CharSequence;IILandroid/text/TextPaint;I)Landroid/text/StaticLayout$Builder;
    ...
    invoke-static {v2, v3}, LNR;->a(Landroid/text/StaticLayout$Builder;Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;

    iget-boolean v3, v1, Lcom/google/android/material/internal/StaticLayoutBuilderCompat;->includePad:Z

    invoke-static {v2, v3}, LSR;->a(Landroid/text/StaticLayout$Builder;Z)Landroid/text/StaticLayout$Builder;
    ...
    :goto_0
    invoke-static {v2, v3}, LJ4;->a(Landroid/text/StaticLayout$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/StaticLayout$Builder;
    ...
    invoke-static {v2, v3}, LPR;->a(Landroid/text/StaticLayout$Builder;Landroid/text/TextUtils$TruncateAt;)Landroid/text/StaticLayout$Builder;

    :cond_4
    iget v3, v1, Lcom/google/android/material/internal/StaticLayoutBuilderCompat;->maxLines:I

    invoke-static {v2, v3}, LOR;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    invoke-static {v2, v3, v4}, LRR;->a(Landroid/text/StaticLayout$Builder;FF)Landroid/text/StaticLayout$Builder;
    ...
    invoke-static {v2, v0}, LJR;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    :cond_8
    invoke-static {v2}, LMR;->a(Landroid/text/StaticLayout$Builder;)Landroid/text/StaticLayout;
