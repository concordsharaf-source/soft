...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/api/client/http/HttpHeaders$b;,
        Lcom/google/api/client/http/HttpHeaders$a;
    }
.end annotation
...
.method public final fromHttpHeaders(Lcom/google/api/client/http/HttpHeaders;)V
    ...
    :try_start_0
    new-instance v0, Lcom/google/api/client/http/HttpHeaders$b;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/google/api/client/http/HttpHeaders$b;-><init>(Lcom/google/api/client/http/HttpHeaders;Ljava/lang/StringBuilder;)V

    new-instance v2, Lcom/google/api/client/http/HttpHeaders$a;

    invoke-direct {v2, p0, v0}, Lcom/google/api/client/http/HttpHeaders$a;-><init>(Lcom/google/api/client/http/HttpHeaders;Lcom/google/api/client/http/HttpHeaders$b;)V
    ...
    invoke-virtual {v0}, Lcom/google/api/client/http/HttpHeaders$b;->a()V
    :try_end_0
...
.method public final fromHttpResponse(Lcom/google/api/client/http/LowLevelHttpResponse;Ljava/lang/StringBuilder;)V
    ...
    invoke-direct {v0, p0, p2}, Lcom/google/api/client/http/HttpHeaders$b;-><init>(Lcom/google/api/client/http/HttpHeaders;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {p0, v2, v3, v0}, Lcom/google/api/client/http/HttpHeaders;->parseHeader(Ljava/lang/String;Ljava/lang/String;Lcom/google/api/client/http/HttpHeaders$b;)V
...
.method public parseHeader(Ljava/lang/String;Ljava/lang/String;Lcom/google/api/client/http/HttpHeaders$b;)V
    .locals 5

    iget-object v0, p3, Lcom/google/api/client/http/HttpHeaders$b;->d:Ljava/util/List;

    iget-object v1, p3, Lcom/google/api/client/http/HttpHeaders$b;->c:Lcom/google/api/client/util/ClassInfo;

    iget-object v2, p3, Lcom/google/api/client/http/HttpHeaders$b;->a:Lcom/google/api/client/util/ArrayValueMap;

    iget-object p3, p3, Lcom/google/api/client/http/HttpHeaders$b;->b:Ljava/lang/StringBuilder;
