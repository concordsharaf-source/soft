...
.method private static on(LLd;)Lcom/google/common/base/Splitter;
    .locals 2

    const-string v0, ""

    invoke-virtual {p0, v0}, LLd;->b(Ljava/lang/CharSequence;)LKd;

    move-result-object v0

    invoke-virtual {v0}, LKd;->d()Z
    ...
    invoke-direct {v1, p0}, Lcom/google/common/base/Splitter$c;-><init>(LLd;)V
...
.method public static on(Ljava/util/regex/Pattern;)Lcom/google/common/base/Splitter;
    ...
    invoke-direct {v0, p0}, Lau;-><init>(Ljava/util/regex/Pattern;)V

    invoke-static {v0}, Lcom/google/common/base/Splitter;->on(LLd;)Lcom/google/common/base/Splitter;
...
.method public static onPattern(Ljava/lang/String;)Lcom/google/common/base/Splitter;
    ...
    invoke-static {p0}, LAG;->a(Ljava/lang/String;)LLd;

    move-result-object p0

    invoke-static {p0}, Lcom/google/common/base/Splitter;->on(LLd;)Lcom/google/common/base/Splitter;
