...
.method public constructor <init>(Lcom/google/android/gms/location/FusedLocationProviderClient;Lcom/google/android/gms/common/api/internal/ListenerHolder;)V
    ...
    iput-object p1, p0, LR40;->c:Lcom/google/android/gms/location/FusedLocationProviderClient;

    iput-object p2, p0, LR40;->b:Lcom/google/android/gms/common/api/internal/ListenerHolder;
...
.method public final bridge synthetic accept(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lh50;->a()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, LR40;->c:Lcom/google/android/gms/location/FusedLocationProviderClient;

    new-instance v1, LU40;

    invoke-direct {v1, v0, p2}, LU40;-><init>(Lcom/google/android/gms/location/FusedLocationProviderClient;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    :try_start_0
    iget-object v0, p0, LR40;->b:Lcom/google/android/gms/common/api/internal/ListenerHolder;
