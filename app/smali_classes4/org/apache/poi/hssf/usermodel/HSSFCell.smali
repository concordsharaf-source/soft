...
.method public constructor <init>(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/usermodel/HSSFSheet;Lorg/apache/poi/hssf/record/CellValueRecordInterface;)V
    ...
    invoke-direct {p2, v0}, Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p2, v0, v1}, Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;-><init>(Lorg/apache/poi/hssf/model/InternalWorkbook;Lorg/apache/poi/hssf/record/LabelSSTRecord;)V
    ...
    invoke-interface {p3}, Lorg/apache/poi/hssf/record/CellValueRecordInterface;->getXFIndex()S

    move-result v0

    invoke-virtual {p2, v0}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getExFormatAt(I)Lorg/apache/poi/hssf/record/ExtendedFormatRecord;
    ...
    invoke-direct {v0, p3, p2, p1}, Lorg/apache/poi/hssf/usermodel/HSSFCellStyle;-><init>(SLorg/apache/poi/hssf/record/ExtendedFormatRecord;Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;)V
...
.method public static findCellComment(Lorg/apache/poi/hssf/model/InternalSheet;II)Lorg/apache/poi/hssf/usermodel/HSSFComment;
    .locals 7
    ...
    instance-of v5, v3, Lorg/apache/poi/hssf/record/NoteRecord;
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/NoteRecord;->getShapeId()I
    ...
    invoke-direct {v4, v3, p0}, Lorg/apache/poi/hssf/usermodel/HSSFComment;-><init>(Lorg/apache/poi/hssf/record/NoteRecord;Lorg/apache/poi/hssf/record/TextObjectRecord;)V

    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/NoteRecord;->getRow()I

    move-result p1

    invoke-virtual {v4, p1}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->setRow(I)V

    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/NoteRecord;->getColumn()I

    move-result p1

    invoke-virtual {v4, p1}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->setColumn(I)V

    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/NoteRecord;->getAuthor()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->setAuthor(Ljava/lang/String;)V

    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/NoteRecord;->getFlags()S
    ...
    :cond_1
    invoke-virtual {v4, v1}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->setVisible(Z)V

    invoke-virtual {p0}, Lorg/apache/poi/hssf/record/TextObjectRecord;->getStr()Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;

    move-result-object p0

    invoke-virtual {v4, p0}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->setString(Lorg/apache/poi/ss/usermodel/RichTextString;)V

    goto/16 :goto_1

    :cond_2
    sget-object p0, Lorg/apache/poi/hssf/usermodel/HSSFCell;->log:Lorg/apache/poi/util/POILogger;

    sget v0, Lorg/apache/poi/util/POILogger;->WARN:I
    ...
    :cond_5
    instance-of v4, v3, Lorg/apache/poi/hssf/record/ObjRecord;
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/CommonObjectDataSubRecord;->getObjectType()S
    ...
    check-cast v4, Lorg/apache/poi/hssf/record/RecordBase;

    instance-of v5, v4, Lorg/apache/poi/hssf/record/TextObjectRecord;

    if-eqz v5, :cond_6

    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/CommonObjectDataSubRecord;->getObjectId()I
...
.method public getCellComment()Lorg/apache/poi/hssf/usermodel/HSSFComment;
    ...
    invoke-static {v0, v1, v2}, Lorg/apache/poi/hssf/usermodel/HSSFCell;->findCellComment(Lorg/apache/poi/hssf/model/InternalSheet;II)Lorg/apache/poi/hssf/usermodel/HSSFComment;
...
.method public getCellFormula()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lorg/apache/poi/hssf/record/aggregates/FormulaRecordAggregate;->getFormulaTokens()[Lorg/apache/poi/hssf/record/formula/Ptg;

    move-result-object v0

    invoke-static {v1, v0}, Lorg/apache/poi/hssf/model/HSSFFormulaParser;->toFormulaString(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;[Lorg/apache/poi/hssf/record/formula/Ptg;)Ljava/lang/String;
...
.method public getHyperlink()Lorg/apache/poi/hssf/usermodel/HSSFHyperlink;
    ...
    invoke-direct {v0, v1}, Lorg/apache/poi/hssf/usermodel/HSSFHyperlink;-><init>(Lorg/apache/poi/hssf/record/HyperlinkRecord;)V
...
.method public getRichStringCellValue()Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;
    ...
    :goto_0
    invoke-direct {v1, v3}, Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;-><init>(Ljava/lang/String;)V
...
.method public removeCellComment()V
    ...
    invoke-virtual {v0}, Lorg/apache/poi/hssf/usermodel/HSSFComment;->getTextObjectRecord()Lorg/apache/poi/hssf/record/TextObjectRecord;
    ...
    instance-of v5, v5, Lorg/apache/poi/hssf/record/ObjRecord;
    ...
    instance-of v5, v5, Lorg/apache/poi/hssf/record/DrawingRecord;
...
.method public setCellArrayFormula(Lorg/apache/poi/ss/util/CellRangeAddress;)V
    ...
    new-instance v0, Lorg/apache/poi/hssf/record/formula/ExpPtg;
    ...
    invoke-direct {v0, v1, p1}, Lorg/apache/poi/hssf/record/formula/ExpPtg;-><init>(II)V
    ...
    invoke-virtual {v0, p1}, Lorg/apache/poi/hssf/record/aggregates/FormulaRecordAggregate;->setParsedExpression([Lorg/apache/poi/hssf/record/formula/Ptg;)V
...
.method public setCellValue(Lorg/apache/poi/ss/usermodel/RichTextString;)V
    ...
    invoke-virtual {v1, p1}, Lorg/apache/poi/hssf/model/InternalWorkbook;->getSSTString(I)Lorg/apache/poi/hssf/record/common/UnicodeString;

    move-result-object p1

    invoke-virtual {v0, p1}, Lorg/apache/poi/hssf/usermodel/HSSFRichTextString;->setUnicodeString(Lorg/apache/poi/hssf/record/common/UnicodeString;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/apache/poi/hssf/record/formula/eval/ErrorEval;->getText(I)Ljava/lang/String;
