.class public Lorg/apache/poi/hssf/record/formula/functions/Days360;
...
.method private static evaluate(DDZ)D
    ...
    invoke-static {p0, p1}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->getStartingDate(D)Ljava/util/Calendar;

    move-result-object p0

    invoke-static {p2, p3, p0}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->getEndingDateAccordingToStartingDate(DLjava/util/Calendar;)Ljava/util/Calendar;
...
.method private static getEndingDateAccordingToStartingDate(DLjava/util/Calendar;)Ljava/util/Calendar;
    ...
    invoke-static {p0, p1}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->getDate(D)Ljava/util/Calendar;
    ...
    invoke-static {v0}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->isLastDayOfMonth(Ljava/util/Calendar;)Z
    ...
    invoke-static {v0}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->getFirstDayOfNextMonth(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method private static getStartingDate(D)Ljava/util/Calendar;
    ...
    invoke-static {p0}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->isLastDayOfMonth(Ljava/util/Calendar;)Z
...
.method public evaluate(IILorg/apache/poi/hssf/record/formula/eval/ValueEval;Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)Lorg/apache/poi/hssf/record/formula/eval/ValueEval;
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->evaluate(DDZ)D
...
.method public evaluate(IILorg/apache/poi/hssf/record/formula/eval/ValueEval;Lorg/apache/poi/hssf/record/formula/eval/ValueEval;Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)Lorg/apache/poi/hssf/record/formula/eval/ValueEval;
    ...
    invoke-static {p5, p1, p2}, Lorg/apache/poi/hssf/record/formula/eval/OperandResolver;->getSingleValue(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;II)Lorg/apache/poi/hssf/record/formula/eval/ValueEval;

    move-result-object p1

    const/4 p2, 0x0

    invoke-static {p1, p2}, Lorg/apache/poi/hssf/record/formula/eval/OperandResolver;->coerceValueToBoolean(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;Z)Ljava/lang/Boolean;
    ...
    :goto_0
    invoke-static {v0, v1, p3, p4, p2}, Lorg/apache/poi/hssf/record/formula/functions/Days360;->evaluate(DDZ)D
