...
.method private checkRuleIndex(I)V
    ...
    iget-object p1, p0, Lorg/apache/poi/hssf/record/aggregates/CFRecordsAggregate;->rules:Ljava/util/List;
...
.method private static shiftRange(Lorg/apache/poi/hssf/record/formula/FormulaShifter;Lorg/apache/poi/ss/util/CellRangeAddress;I)Lorg/apache/poi/ss/util/CellRangeAddress;
    .locals 10

    new-instance v9, Lorg/apache/poi/hssf/record/formula/AreaPtg;
    ...
    invoke-direct/range {v0 .. v8}, Lorg/apache/poi/hssf/record/formula/AreaPtg;-><init>(IIIIZZZZ)V
    ...
    invoke-virtual {p0, v0, p2}, Lorg/apache/poi/hssf/record/formula/FormulaShifter;->adjustFormula([Lorg/apache/poi/hssf/record/formula/Ptg;I)Z
    ...
    instance-of p1, p0, Lorg/apache/poi/hssf/record/formula/AreaPtg;

    if-eqz p1, :cond_1

    check-cast p0, Lorg/apache/poi/hssf/record/formula/AreaPtg;
    ...
    :cond_1
    instance-of p1, p0, Lorg/apache/poi/hssf/record/formula/AreaErrPtg;
...
.method public addRule(Lorg/apache/poi/hssf/record/CFRuleRecord;)V
    ...
    invoke-virtual {p1, v0}, Lorg/apache/poi/hssf/record/CFHeaderRecord;->setNumberOfConditionalFormats(I)V
...
.method public cloneCFAggregate()Lorg/apache/poi/hssf/record/aggregates/CFRecordsAggregate;
    ...
    invoke-direct {v0, v2, v1}, Lorg/apache/poi/hssf/record/aggregates/CFRecordsAggregate;-><init>(Lorg/apache/poi/hssf/record/CFHeaderRecord;[Lorg/apache/poi/hssf/record/CFRuleRecord;)V
...
.method public getRule(I)Lorg/apache/poi/hssf/record/CFRuleRecord;
    ...
    check-cast p1, Lorg/apache/poi/hssf/record/CFRuleRecord;
...
.method public updateFormulasAfterCellShift(Lorg/apache/poi/hssf/record/formula/FormulaShifter;I)Z
    .locals 8
    ...
    invoke-static {p1, v5, p2}, Lorg/apache/poi/hssf/record/aggregates/CFRecordsAggregate;->shiftRange(Lorg/apache/poi/hssf/record/formula/FormulaShifter;Lorg/apache/poi/ss/util/CellRangeAddress;I)Lorg/apache/poi/ss/util/CellRangeAddress;
    ...
    invoke-virtual {p1, v1, p2}, Lorg/apache/poi/hssf/record/formula/FormulaShifter;->adjustFormula([Lorg/apache/poi/hssf/record/formula/Ptg;I)Z

    move-result v3

    if-eqz v3, :cond_5

    invoke-virtual {v0, v1}, Lorg/apache/poi/hssf/record/CFRuleRecord;->setParsedExpression1([Lorg/apache/poi/hssf/record/formula/Ptg;)V
    ...
    invoke-virtual {v0, v1}, Lorg/apache/poi/hssf/record/CFRuleRecord;->setParsedExpression2([Lorg/apache/poi/hssf/record/formula/Ptg;)V
