...
.method private areValuesEqual(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)Z
    .locals 5
    ...
    check-cast p2, Lorg/apache/poi/hssf/record/formula/eval/NumberEval;

    invoke-virtual {p2}, Lorg/apache/poi/hssf/record/formula/eval/NumberEval;->getNumberValue()D
    ...
    check-cast p2, Lorg/apache/poi/hssf/record/formula/eval/StringEval;

    invoke-virtual {p2}, Lorg/apache/poi/hssf/record/formula/eval/StringEval;->getStringValue()Ljava/lang/String;
    ...
    check-cast p2, Lorg/apache/poi/hssf/record/formula/eval/BoolEval;

    invoke-virtual {p2}, Lorg/apache/poi/hssf/record/formula/eval/BoolEval;->getBooleanValue()Z
    ...
    check-cast p2, Lorg/apache/poi/hssf/record/formula/eval/ErrorEval;

    invoke-virtual {p2}, Lorg/apache/poi/hssf/record/formula/eval/ErrorEval;->getErrorCode()I
...
.method public getPlainValueEntry(IIIILorg/apache/poi/hssf/record/formula/eval/ValueEval;)Lorg/apache/poi/ss/formula/PlainValueCellCacheEntry;
    .locals 1
    ...
    invoke-direct {p1, p5}, Lorg/apache/poi/ss/formula/PlainValueCellCacheEntry;-><init>(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)V
    ...
    :cond_0
    invoke-virtual {p1}, Lorg/apache/poi/ss/formula/CellCacheEntry;->getValue()Lorg/apache/poi/hssf/record/formula/eval/ValueEval;

    move-result-object v0

    invoke-direct {p0, v0, p5}, Lorg/apache/poi/ss/formula/EvaluationCache;->areValuesEqual(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)Z
    ...
    invoke-interface {v0, p2, p3, p4, p5}, Lorg/apache/poi/ss/formula/IEvaluationListener;->onCacheHit(IIILorg/apache/poi/hssf/record/formula/eval/ValueEval;)V
...
.method public notifyUpdateCell(IILorg/apache/poi/ss/formula/EvaluationCell;)V
    ...
    :cond_4
    invoke-static {p3}, Lorg/apache/poi/ss/formula/WorkbookEvaluator;->getValueFromNonFormulaCell(Lorg/apache/poi/ss/formula/EvaluationCell;)Lorg/apache/poi/hssf/record/formula/eval/ValueEval;
    ...
    invoke-direct {v10, v1}, Lorg/apache/poi/ss/formula/PlainValueCellCacheEntry;-><init>(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)V
    ...
    :cond_7
    invoke-virtual {v10, v1}, Lorg/apache/poi/ss/formula/CellCacheEntry;->updateValue(Lorg/apache/poi/hssf/record/formula/eval/ValueEval;)Z
